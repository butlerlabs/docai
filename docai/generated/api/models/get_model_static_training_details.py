...
from ...models.model_static_training_details_dto import ModelStaticTrainingDetailsDto
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/internal/models/{id}/training_details/static".format(client.base_url, id=id)
...
def _parse_response(*, response: httpx.Response) -> Optional[ModelStaticTrainingDetailsDto]:
    if response.status_code == 200:
        response_200 = ModelStaticTrainingDetailsDto.from_dict(response.json())

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[ModelStaticTrainingDetailsDto]:
    return Response(
