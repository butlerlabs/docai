...
from ...models.upload_documents_to_test_multipart_data import UploadDocumentsToTestMultipartData
...
def _get_kwargs(
    ...
    *,
    ...
    multipart_data: UploadDocumentsToTestMultipartData,
) -> Dict[str, Any]:
    url = "{}/api/internal/document_types/{docTypeId}/upload_test_docs".format(client.base_url, docTypeId=doc_type_id)
...
def sync_detailed(
    ...
    *,
    ...
    """Upload documents to the document type for Live Test
