...
T = TypeVar("T", bound="UpdateDocumentLabelsResponseDto")


@attr.s(auto_attribs=True)
class UpdateDocumentLabelsResponseDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_document_labels_response_dto = cls(
            document_id=document_id,
            document_status=document_status,
            document_confidence=document_confidence,
        )

        update_document_labels_response_dto.additional_properties = d
        return update_document_labels_response_dto
