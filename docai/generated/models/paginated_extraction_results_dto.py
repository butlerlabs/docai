...
T = TypeVar("T", bound="PaginatedExtractionResultsDto")
...
class PaginatedExtractionResultsDto:
    ...
    has_previous: bool
    total_count: float
    items: List[ExtractionResultsDto]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ExtractionResultsDto.from_dict(items_item_data)

            items.append(items_item)

        paginated_extraction_results_dto = cls(
            has_next=has_next,
        ...
        paginated_extraction_results_dto.additional_properties = d
        return paginated_extraction_results_dto
