...
T = TypeVar("T", bound="PaginatedQueueDto")
...
class PaginatedQueueDto:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = QueueDto.from_dict(items_item_data)

            items.append(items_item)

        paginated_queue_dto = cls(
            has_next=has_next,
        ...
        paginated_queue_dto.additional_properties = d
        return paginated_queue_dto
