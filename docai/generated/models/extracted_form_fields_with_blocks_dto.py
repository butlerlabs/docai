...
T = TypeVar("T", bound="ExtractedFormFieldsWithBlocksDto")


@attr.s(auto_attribs=True)
class ExtractedFormFieldsWithBlocksDto:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        extracted_form_fields_with_blocks_dto = cls(
            id=id,
        ...
        extracted_form_fields_with_blocks_dto.additional_properties = d
        return extracted_form_fields_with_blocks_dto
