...
SAMPLE_DOC_TYPE_SCHEMA_DICT = {
    "id": "ef6a3ae7-a285-4aa6-9f4c-45829c1350f0",
    "name": "Bank Statements",
    "description": "Extracts fields like Account, Bank and Statement Information, Balances and Transaction Amounts",
    "status": "Active",
    "modelType": "BankStatement",
    "formFields": [
        {"id": "5ba85135-4b98-4129-a9bb-15fd91c1d13b", "name": "Account Number"},
        {"id": "b499b7b3-5b90-402a-ad25-be76b5946eff", "name": "Account Type"},
        {"id": "8a5a8ee1-89f1-4107-a9ce-aeb8b3f3417c", "name": "Bank Address"},
        {"id": "e96c8ec1-c025-4c96-8c28-d1fbc3aeab57", "name": "Bank Name"},
        {"id": "6cbb4f44-b6f6-49c8-8dd9-6d2b3bac633f", "name": "Client Address"},
        {"id": "7a8e0080-bdd0-4fdb-a37e-080047b426e3", "name": "Client Name"},
        {"id": "51f90cb8-5adf-4b74-8956-201f241f23ba", "name": "Ending Balance"},
        {"id": "e6982958-7581-4411-9fb2-c7b898fe6f6c", "name": "Starting Balance"},
        {"id": "c97ac86d-a063-436d-964c-f84b5b4c8ef0", "name": "Statement Date"},
        {"id": "0e45087a-207c-48c7-a3ff-f04421f24c2b", "name": "Statement End Date"},
        {"id": "5906e15f-b346-40c1-b394-3adf4da1620e", "name": "Statement Start Date"},
    ],
    "tables": [
        {
...
class TestModelClient:
    ...
    def before_each_and_after_each(self):
        with ExitStack() as stack:
            ...
            self.get_document_type_schema_patch = patch_fn(
                "docai.models.model_client.get_document_type_schema.sync_detailed"
            )
    ...
    def test_clone_model_schema(self):
        ...
        dr = Response(
            status_code=200,
            content=json.dumps(SAMPLE_DOC_TYPE_SCHEMA_DICT).encode("utf-8"),
            headers={},
            parsed=DocumentTypeSchemaDto.from_dict(SAMPLE_DOC_TYPE_SCHEMA_DICT),
        )
        mi = Response(
            status_code=201, content=json.dumps(SAMPLE_MODEL_INFO_DICT).encode("utf-8"), parsed=None, headers={}
        )
